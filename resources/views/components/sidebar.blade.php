...
<ul id="sideNav" class="side-nav-menu side-nav-menu-top-level mb-0">
  ...
  <!-- End Users -->
    ...
    <!-- Notifications -->
	<li class="side-nav-menu-item side-nav-has-menu {{ Request::is('notification') ? 'active' : '' }}">
	<a class="side-nav-menu-link media align-items-center" href="#"
	...
	<!-- Notifications: sub -->
	<ul id="notification" class="side-nav-menu side-nav-menu-second-level mb-0">
	  <li class="side-nav-menu-item {{ Request::is('notification') ? 'active' : '' }}">
