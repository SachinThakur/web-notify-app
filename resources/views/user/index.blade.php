		...
		<div class="table-responsive-xl">
			<table class="table text-nowrap mb-0">
				...
				<tr>
					...
					<th class="font-weight-semi-bold border-top-0 py-2">Notification(Unread)</th>
				...
				<tr>
					...
					<td class="py-3">{{ $user['unread'] }}</td>
					<td class="py-3">
						<div class="position-relative">
							<a class="link-dark d-inline-block" href="{{ route('user.edit', $user['id']) }}">
							...
							<form id="delete-entity-{{ $user['id'] }}" action="{{ route('user.destroy', $user['id']) }}" method="POST">
